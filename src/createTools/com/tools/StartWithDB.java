...
import com.tools.jdbc.DataSource;
import com.tools.jdbc.DmJdbcService;
import com.tools.jdbc.JdbcType;
import com.tools.jdbc.MySQLJdbcService;
...
//	public static String pmanRequestHost = "http://{{host}}";
	...
	static String webname = "yd";
	static String sys_module=webname.concat("-ss");
	static String sys_module_path = "./" + sys_module + "/com/project/" + webname;
	static String core_module=webname.concat("-core");
	static String web_module=webname.concat("-web");

	static String packagepath = "./" + sys_module + "/com/project/ctrl/" + webname;
	...
	public static void main(String[] args) throws Exception {
		...
		/*************************************mysql数据库配置开始******************************************/
		DataSource mysql = new DataSource(JdbcType.MYSQL,"jdbc:mysql://localhost:3306/javaCode?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai","javaCode","javaCode");
		MySQLJdbcService mySQLJdbcService = new MySQLJdbcService(mysql);
		List<DBTable> pdmTables = mySQLJdbcService.getTablesAndViews();
		/*************************************mysql数据库配置结束******************************************/


		/*************************************达梦数据库配置开始******************************************/
//		DataSource dm = new DataSource(JdbcType.MYSQL,
//                "jdbc:mysql://localhost:3306/javaCode?useUnicode=true&characterEncoding=UTF-8",
//                "javaCode",
//                "javaCode");
//
//		DmJdbcService dmJdbcService = new DmJdbcService(dm);
//		List<DBTable> pdmTables = dmJdbcService.getTablesAndViews();
		/*************************************达梦数据库配置结束******************************************/
	...
	public static void create(List<DBTable> tables) throws Exception{
...
//
		...
		tofile.viewController(new File(packagepath + webname + "/controller"), tables);
...
//		tofile.webXmlContent(new File(web_xml), webname);
	...
	public static void clear(List<DBTable> tables) throws Exception{
