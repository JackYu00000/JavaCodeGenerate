...
public class ControllerMethodDel extends ControllerMethodBase {

	public ControllerMethodDel(DBTable table){
		this.table = table;
	}
	...
	public PManRequest genInterfaceJsonPMRequest(String collectionId,String jsonString, String lastFolderId) {
		this.pmanRequest = new PManRequest(UUID.randomUUID().toString()
				...
				,collectionId
				,jsonString
				,Start.pmanRequestHost + "/apijson/" + CreateUtils.getTab(table.getCode()).toLowerCase() + "/del"
				,lastFolderId);
	...
	public PManRequest genInterfaceMobiPMRequest(String collectionId,String jsonString, String lastFolderId) {
		this.pmanRequest = new PManRequest(UUID.randomUUID().toString()
				...
				,collectionId
				,jsonString
				,Start.pmanRequestHost + "/apimobi/" + CreateUtils.getTab(table.getCode()).toLowerCase() + "/del"
				,lastFolderId);
		return this.pmanRequest;
	}
